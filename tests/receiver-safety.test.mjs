...
assert.ok(indexHtml.includes("app.js?v=81"), "index.html must cache-bust app.js with the current receiver build");
...
assert.ok(!source.includes("function lockAndroidPreview"), "Android must not lock focus or the preview cannot acquire the screen");
...
assert.ok(serviceWorker.includes('const CACHE_NAME = "airferry-lite-v81";'), "service worker cache version was not bumped");
