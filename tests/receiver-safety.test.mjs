...
assert.ok(indexHtml.includes("app.js?v=60"), "index.html must cache-bust app.js with the current receiver build");
...
assert.ok(serviceWorker.includes('const CACHE_NAME = "airferry-lite-v60";'), "service worker cache version was not bumped");
