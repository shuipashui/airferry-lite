...
3. 手机打开网页接收端或安装 APK，允许摄像头并开始扫描。
4. 对准二维码保持稳定；接收完成后保存或下载文件。
...
|---|---|
| 单码 | **2331 B · 30 FPS** |
| 四码 | **全屏 · 2331 B · 30 FPS**（每码上限 1273 B） |
| 近距离、画面清晰 | 2953 B · 30 FPS（仅单码） |
| 较远或摩尔纹明显 | 1465 B，或四码 1003 B · 24/30 FPS |
| 不要用 | 单码 60/120 FPS；60 Hz 屏上的四码 60 FPS（容易拖影，往往更慢） |
